...
public class PushMessage {
	...
	private static final String appKey ="7db7ae7cd8185b3491e64e4e";
	private static final String masterSecret = "c03b643a1668e961ca069f64";
	...
	public static void sendMessage(String message) {
        ...
        //构建PushPayload
        PushPayload payload = buildExeaMessage(message);
     ...
     * @return
     */
    public static PushPayload buildExeaMessage(String message) {
        return PushPayload.newBuilder()
                .setPlatform(Platform.android())
                .setAudience(Audience.newBuilder()
                		//设置推送目标为管理员
                        .addAudienceTarget(AudienceTarget.tag("" + Const.UserType.MANAGER))
                        .build())
